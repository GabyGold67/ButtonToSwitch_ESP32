/**
  ******************************************************************************
  * @file	: BtsFdaStates_ESP32.h
  * @brief	: Header file for the ButtonToSwitch_ESP32 library's iFdaDmpbStates
  * interface implementation classes
  *
  * @details The classes included implement the ContextBts and the IFdaDmpbState
  *  interface class, allowing the ButtonToSwitch_ESP32 objects... 
  *
...
#ifndef BTSFDASTATES_ESP32_H
#define BTSFDASTATES_ESP32_H
#include <Arduino.h>
...
class FdaDmpbStateIdle: public IFdaDmpbState{
};
