/**
  ...
  * WOKWI simulation URL: https://wokwi.com/projects/437732485455815681
  * 
  * Framework: Arduino
  * Platform: ESP32
  * 
  ...
  * 
  * In the main control task the TgglLtchMPBttn object is instantiated and configured
...
void loop() {
   vTaskDelete(NULL);   // Delete this task as it's not needed
}  
