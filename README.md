...
### The main output attribute flag kept updated for each and every class is the **isOn** flag, which defines the ***Off State*** (isOn=false) and the ***On State*** (isOn=true) of the instantiated objects.
